...
%Date
    {\small Last Update: \today
      \\
      \cbstart
      \textit{Changes highlighted with a green bar.}
      \cbend
    }
\end{minipage}
\end{center}
...
\begin{enumerate}
  ...
  \item \textbf{2018-02-28} Dispensing of pre-packaged pills for specific patients
...
\item \textbf{2018-02-28} Implementation of database and software interface
  ...
  \item \textbf{2018-03-14} Implementation of polished interface and alerting engine.
\end{enumerate}
\cbend
