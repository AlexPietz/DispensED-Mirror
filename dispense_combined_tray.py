...
number_pills_1 = int(sys.argv[1]) # number of pills to be dispensed by dispenser A
number_pills_2 = int(sys.argv[2]) # number of pills to be dispensed by dispenser B

i = 0
while i < 2:
    if i == 0:
        motor = motor_A
        number_pills = number_pills_1
    else:
        motor = motor_B
        number_pills = number_pills_2
    ...
    while (count_dispensed < number_pills):
        ...
        if (not dispensing and stopfor == 0):
            ...
            if (less and cl_A.value() >= (initial-2)):
                ...
                stopfor = 20
            elif (not less and cl_A.value() <= (initial+1) and cl_A.value() >= (initial-1)):
